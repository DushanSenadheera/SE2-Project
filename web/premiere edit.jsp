                ...
                <div class="container">
                    ...
                    <form action="premierMovie" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="set-price">
                            <label for="price">
                                <h3>Set Price</h3>
                                <input type="text" id="price01" name="gold" placeholder="Gold" value="<%=rs.getString(10)%>">
                                <input type="text" id="price02" name="silver" placeholder="Silver" value="<%=rs.getString(11)%>">
                                <input type="text" id="price03" name="bronze" placeholder="Bronze" value="<%=rs.getString(12)%>">
                            </label> 
                        </div>
                        <%
